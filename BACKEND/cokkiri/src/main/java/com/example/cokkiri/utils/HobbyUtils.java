...
public class HobbyUtils {
    ...
    static{
        ...
        hobbies.put("쇼핑", "3b0");
        hobbies.put("외식", "3c0");
        hobbies.put("독서(웹소설 포함)", "3d0");
        hobbies.put("만화(애니, 웹툰)", "3e0");
        hobbies.put("피 부관리", "3f0");
        hobbies.put("헤어 관리", "3f1");
        hobbies.put("네일 아트", "3f2");
        hobbies.put("마사지", "3f3");
        hobbies.put("공부", "3g0");
        hobbies.put("이색/테마카페 체험(방탈출, VR, 낚시카페 등)", "3h0");
        hobbies.put("원예(화분, 화단 가꾸기 등)", "3i0");
        hobbies.put("산책", "400");
